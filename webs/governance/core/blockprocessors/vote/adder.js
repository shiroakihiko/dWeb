    ...
    async addBlock(block) {
        try {
            return await this.ledger.blocks.transaction(async () => {
                ...
                accountRecipient.increaseField('totalVotingPower', parseFloat(accountSender.account.votingPower));
                accountRecipient.increaseField('totalVotingScore', parseFloat(block.score) * parseFloat(accountSender.account.votingPower));
