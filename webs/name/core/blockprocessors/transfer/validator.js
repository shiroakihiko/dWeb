...
class TransferBlockValidator extends BaseBlockValidator {
    constructor(network) {
        super(network);
        ...
        // Add transfer-specific schema properties
    ...
    async validateDomain(block) {
        ...
        if(domain.toAccount === block.fromAccount) {
...
module.exports = TransferBlockValidator;